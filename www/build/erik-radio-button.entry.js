...
const RadioButton = class {
    ...
    render() {
        ...
        return (h(Host, { role: "radio", "aria-checked": this.checked, scale: this.scale }, h("input", { id: id, type: "radio", name: this.name, checked: this.checked, value: this.value }), h("span", { id: "radio", class: `${this.scale} ${this.checked && "checked"}` }), h("label", { htmlFor: id }, h("slot", null))));
    }
